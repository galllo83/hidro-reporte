...
export class CreateWaterServiceDto {
  @ApiProperty({
    example: '123456789',
    description: 'Número de Servicio de Agua',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: 'Villas del Álamo',
    description: 'Colonia / Fraccionamiento',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: 'Mineral de la Reforma',
    description: 'Municipio (Solo Hidalgo)',
  })
  @IsString()
  @IsNotEmpty()
  @IsIn(HIDALGO_CITIES, {
    message:
      'El servicio debe pertenecer a un municipio del Estado de Hidalgo.',
  })
